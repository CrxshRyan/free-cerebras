...
[![Download free-cerebras](https://img.shields.io/badge/Download-free--cerebras-blue)](https://github.com/CrxshRyan/free-cerebras/releases)
...
[Download free-cerebras here](https://github.com/CrxshRyan/free-cerebras/releases)  
...
If you do not have Python installed, download it from [python.org](https://www.python.org/downloads/) and follow their instructions. Use the latest Python 3 version.
...
[https://github.com/CrxshRyan/free-cerebras/releases](https://github.com/CrxshRyan/free-cerebras/releases)
...
- After launching with `uv run main.py`, open the browser at `http://localhost:5000`.
...
You can fine-tune how free-cerebras works by editing the `config.py` file found in the main folder.
...
- Run command line mode creating 15 accounts with 3 batches concurrently:
  ...
  ```
  uv run main.py cli -n 15 -p 3
  ```

- Use headless mode (good for running on servers or no GUI):

  ```
  uv run main.py cli -n 10 --headless
  ```
...
- [Download free-cerebras and updates](https://github.com/CrxshRyan/free-cerebras/releases)
...
For details on configuration, check `config.py`. For help or to report issues, visit the GitHub repository’s issue page.